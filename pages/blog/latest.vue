...
<div>
  <div class="container" id="list_latest_news">
    <div class="col-12 col-md-10 offset-md-1">
      <no-ssr>
      <div class="card-columns cards-news my-5" data-aos="fade-up" v-show="news.data">
        ...
        <div class="card " v-for="item in news.data" :key="item.id">
          <div class="news">
            ...
            <div class="card-body">
              ...
              <nuxt-link class="detail-link type-article mt-4" :to="{name: 'blog-id', params: { id: item.id} }">READ ARTICLE</nuxt-link>
            </div>
