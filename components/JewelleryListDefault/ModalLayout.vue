                ...
                <b-tabs class="mt-3 tabs-category-detail-info" align="center">
                  <b-tab title="OVERVIEW" active>
                    ...
                    <div class="col-12">
                      <div class="row" v-if="variantsSort">
                        <div v-for="(option, key) in variantsSort" :key="key">
                  ...
                  <b-tab title="DETAILS">
                    <div class="group-desc">
                      ...
                      <div class="item-information" v-if="data.item_details.stones_carats">
                        <div class="title">CARAT RANGE</div>
                        <div
                          class="text"
                        >{{data.item_details.stones_carats.min}} to {{data.item_details.stones_carats.max}}</div>
                      </div>
                    </div>
                  </b-tab>
                </b-tabs>
