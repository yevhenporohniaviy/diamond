                  ...
                  <div class="row">
                    <div class="col-12 pr-0">
                      <div class="main-image" v-if="  data.item_details.images">
                        <img
                          :src="activeImage  ? activeImage : baseUrl + data.item_details.images.main"
                          class="img-fluid"
                        />
                        <div class="icon-logo">
                    ...
                    <div class="col-12">
                      <slick :options="slickOptions" v-if="data.item_details.images">
                        <div
                        ...
                        >
                          <div class="support-images">
                            <img :src="baseUrl+item" class="img-fluid" @click="onChangeMain(item)" />
                          </div>
                        </div>
                        <div
          ...
          <div class="col-12 p-0">
            <div class="slider-detail-images" v-if="data.item_details.images">
              ...
              <Flickity :options="flickityOptions" id="flickity-tab">
                ...
                <div
                  class="carousel-cell"
                  v-for="(item,key,index) in data.item_details.images"
                  :key="index"
                  v-if="key !== 'on_hand' || item.on_hand"
                >
                  <div class="flick-image">
        ...
        <div class="row justify-content-center">
          ...
          <div class="col-md-8 col-12 d-flex justify-content-center align-items-center my-4">
            <nuxt-link
              ...
              :to="{name: 'diamonds-pair', params: {  shape: [ ...data.item_details.stone_shape ] } } "
  ...
  methods: {
    ...
    activeSelect(e) {
      if (e[0].alias !== "ring_size") {
        this.activeImage = this.baseUrl + e[0].image;
      }
      this.$forceUpdate();
    },
