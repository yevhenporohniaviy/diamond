      ...
      <div class="col-12 ">
        ...
        <div class="count-range mb-3">
          <div class="count-range">
            <div class="min-count">
              <input type="number" class="input-filter-number" pattern="[0-9]" v-model.number="depth[0]" @change="selectNumberMobile(filter_item.alias, depth)" :max="depth[1]">
            </div>
            -
            <div class="max-count">
              <input type="number" class="input-filter-number" pattern="[0-9]" v-model.number="depth[1]" @change="selectNumberMobile(filter_item.alias, depth)" :max="depth[1]">
            </div>
          </div>
        </div>
        <div class="my-4">
          <vue-slider
            ...
            :tooltip="'none'"
            :min-range="1"
            @drag-end="selectNumberMobile(filter_item.alias, depth)">
          </vue-slider>
        </div>
