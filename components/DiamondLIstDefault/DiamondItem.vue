<template>
  <div class="col-lg-4 col-xl-3 col-md-6 col-sm-4 col-12">
    ...
    @mouseleave="mouseOut"
    v-if="post">
    <div class="default-diamond-item item">
      <div class="img-block text-center">
            ...
            <el-tooltip class effect="light" content="PAIR WITH ..." placement="top">
              ...
              >
                ...
                <el-button slot="reference">
                  <img class="img-fluid" src="~assets/img/pair_with-1.png" />
                </el-button>
              </el-popover>
            </el-tooltip>
          </div>
        ...
        <nuxt-link :to="{name: 'diamonds-list-id', params: { id: post.item_id} }">
          <img
            class="img-fluid my-4 diamond-img"
            :src=" post.item_details.images.main+'?h=280&w=280&fit=cover'"
            v-show="!active"
          />
          <img
            class="img-fluid my-4 diamond-img"
            :src=" post.item_details.images.side+'?h=280&w=280&fit=cover'"
            v-show="active"
          />
      ...
      <div class="social-block d-flex justify-content-center">
        ...
        <div class="share" @click="openSharing">
    ...
    <el-dialog :visible.sync="showSharing"
               ...
               >
      <ModalSharing :data="post.item_id" :type="post.item_type" @close-sharing="closeSharing"/>
    </el-dialog>
  </div>
</template>
<script>
