      ...
      <div class="container">
        <div class="row justify-content-center align-items-center">
            ...
            <div class="step-content">
              <div class="row justify-content-center align-items-center">
                <div class="col-5 text-right">
                  <div class="content-title">Your estimated budget</div>
                </div>
          ...
          <div class="dots-step d-flex justify-content-center align-items-center">
            <img src="~assets/img/stepdots4@3x.png" class="img-fluid" width="40%" />
          </div>
        </div>
      </div>
    </section>
...
export default {
  ...
  methods: {
    skipStep() {
      ...
      document.getElementById("step-appoint5").style.display = "block";
      this.$scrollTo("#step-appoint5", options);
      document.documentElement.style.overflow = "hidden";
    },
    sendData() {
      if (
        Object.entries(this.fieldStepSecond).length === 0 &&
        this.fieldStepSecond.constructor === Object
      ) {
        this.$notify({
          title: "Warning",
